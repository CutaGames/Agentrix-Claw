...
const breakdown: CSSProperties = { fontSize: 12, color: "var(--text-muted)", marginBottom: 16 };
const muted: CSSProperties = { color: "var(--text-muted)", textAlign: "center", padding: "12px 0", fontSize: 13 };
