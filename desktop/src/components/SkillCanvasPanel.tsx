                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      left: node.x,
                      top: node.y,
                      borderColor: selected ? color.border : "var(--border-subtle)",
                      background: selected ? color.fill : "var(--bg-elevated)",
...
const subtitle: CSSProperties = { marginTop: 6, color: "var(--text-muted)", fontSize: 13 };
...
const sectionTitle: CSSProperties = { fontSize: 14, fontWeight: 700, color: "var(--text-strong)", marginTop: 4 };
...
const instanceValue: CSSProperties = { fontSize: 12, color: "var(--text-card)", textAlign: "right", wordBreak: "break-word" };
...
const fieldLabel: CSSProperties = { fontSize: 11, textTransform: "uppercase", letterSpacing: 0.8, color: "var(--text-muted)" };
...
const canvasHeader: CSSProperties = { color: "var(--text-muted)", fontSize: 12 };
...
const statusDone: CSSProperties = { color: "#bbf7d0", borderColor: "var(--tone-success-border)", background: "rgba(20,83,45,0.22)" };
const statusFailed: CSSProperties = { color: "#fecaca", borderColor: "var(--tone-danger-border)", background: "rgba(127,29,29,0.22)" };
...
const resultStep: CSSProperties = { fontSize: 12, fontWeight: 700, color: "var(--text-strong)" };
const resultNote: CSSProperties = { marginTop: 5, fontSize: 12, color: "var(--text-muted)", lineHeight: 1.5 };
...
const nodeLabel: CSSProperties = { marginTop: 10, fontSize: 15, fontWeight: 700, color: "var(--text-strong)" };
const nodeNote: CSSProperties = { marginTop: 8, fontSize: 12, color: "var(--text-muted)", lineHeight: 1.45 };
const nodeStepMeta: CSSProperties = { marginTop: 10, fontSize: 11, color: "var(--text-muted)", lineHeight: 1.4 };
