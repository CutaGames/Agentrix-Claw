...
const TIER_COLORS: Record<SubscriptionTier, { bg: string; fg: string; border: string }> = {
  ...
  elite:      { bg: "rgba(251,191,36,0.18)",  fg: "#fbbf24", border: "rgba(251,191,36,0.5)" },
  ...
  return (
    <>
      <button
        ...
        style={{ ...badgeStyle, background: c.bg, color: c.fg, borderColor: c.border }}
      ...
      >
        ...
        {budgetCents > 0 && (
          <span style={{ ...budgetStyle, color: overBudget ? "#f87171" : c.fg }}>
            {pct}%
          </span>
        )}
      </button>
