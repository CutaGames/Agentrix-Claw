        ...
        >
              ...
              {ASPECT_OPTIONS.map((a) => (
                <button
                  ...
                  style={{
                    ...btnStyle,
                    flex: 1,
                    background: aspect === a ? "#6C5CE7" : "var(--bg-overlay-light)",
          ...
          {studioMode === "single" ? (
            ...
            <>
              ...
              {composeJob && (
                <div style={{ marginTop: 12, padding: 10, background: "var(--bg-card)", borderRadius: 6, fontSize: 12 }}>
            ...
            {tasks.map((t) => (
              ...
              >
                {t.thumbnailUrl ? (
                  ...
                  <div style={{ height: 120, borderRadius: 6, background: "var(--bg-card)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 32 }}>
                    🎞️
                  </div>
                )}
