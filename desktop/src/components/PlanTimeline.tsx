  ...
  return (
    <div style={containerStyle}>
      <header style={headerStyle}>
        <div>
          <div style={{ fontSize: 18, fontWeight: 600, color: "var(--text-strong)" }}>{plan.title}</div>
  ...
  return (
    <div style={{ ...stepCardStyle, borderLeftColor: color }}>
      <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontSize: 14, color: "var(--text-strong)", fontWeight: 500 }}>{step.description}</div>
