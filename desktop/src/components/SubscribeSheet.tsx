    ...
    <div style={backdropStyle} onClick={onClose}>
      <div style={sheetStyle} onClick={(e) => e.stopPropagation()}>
        ...
        {selectedEntry && selectedPriceCents > 0 && (
          <div style={axpBlock}>
            <div style={{ fontSize: 13, fontWeight: 700, color: "#e5e7eb", marginBottom: 6 }}>
              💎 使用 AXP 抵扣
            </div>
...
const subtitleStyle: CSSProperties = { fontSize: 11, color: "#9ca3af", marginTop: 3 };
...
const cardStyle: CSSProperties = {
  ...
  background: "rgba(255,255,255,0.03)", textAlign: "left", color: "#e5e7eb",
};
...
const emptyStyle: CSSProperties = { padding: 24, textAlign: "center", color: "#9ca3af", fontSize: 12 };
