  ...
  return (
    <div style={sheetStyle} onClick={(e) => e.stopPropagation()}>
      <div style={sheetHeader}>
        <div>
          <div style={{ fontSize: 12, color: "#9ca3af" }}>AXP 余额</div>
...
const rowSrcStyle: CSSProperties = { color: "#e5e7eb", fontWeight: 600 };
const rowNoteStyle: CSSProperties = { color: "#9ca3af", fontSize: 11, marginTop: 2 };
