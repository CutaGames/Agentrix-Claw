...
export class PetTeamMember {
  ...
  /**
   * Multi-Agent v1 (W3) — denormalized AgentAccount.id for fast
   * `selectMember` dispatch (avoids living_pets join). NULL when the
   * member has not yet been bound to an AgentAccount (W3.2 binding).
   *
