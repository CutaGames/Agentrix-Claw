...
export class SkillController {
  ...
  // ⚠️ ROUTE ORDER: `installed` MUST be declared before the `:id` wildcard route
  // below, otherwise GET /skills/installed is captured by @Get(':id') and
  // treats "installed" as a UUID → 500 "invalid input syntax for type uuid".
  // (Fix 2026-06-01: this is why "我的技能" was always empty.)
  @UseGuards(JwtAuthGuard)
  @Get('installed')
