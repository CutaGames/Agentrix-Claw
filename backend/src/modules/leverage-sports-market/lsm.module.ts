...
import { AxpAssetAdapter, StablecoinAssetAdapter, assetAdapterFactory, LSM_ASSET_ADAPTER } from './lsm-asset.adapter';
...
@Module({
  ...
  controllers: [LsmController, LsmVaultController, LsmAdminController],
  providers: [
    LsmFeedService,
    LsmFeedPoller,
    LsmMarketService,
