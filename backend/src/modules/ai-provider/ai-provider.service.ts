...
export interface ProviderDef {
  ...
  /** 'chat' (default) | 'media' — media providers do video/image/3D generation, not chat. */
  kind?: 'chat' | 'media';
  /** For media providers: which modalities this provider can generate. */
...
const PLATFORM_MODEL_ALIASES: Record<string, { label: string; multimodal: boolean }> = {
  ...
  'claude-opus-4-8': { label: 'Claude Opus 4.8 (平台旗舰 API)', multimodal: true },
...
const SUBSCRIPTION_MODEL_ALIASES: Record<string, string> = {
  ...
  'copilot-sub-claude-opus-4.8': 'claude-opus-4.8',
  ...
  'deepseek-plan-v4.0-pro': 'deepseek-v4.0-pro',
  'deepseek-plan-v4.0-flash': 'deepseek-v4.0-flash',
  ...
  // ── Xiaomi MiMo Subscription (小米订阅) ──
  'xiaomi-plan-mimo-v2.5-pro': 'mimo-v2.5-pro',
  'xiaomi-plan-mimo-v2-flash': 'mimo-v2-flash',
};
...
export const PROVIDER_CATALOG: ProviderDef[] = [
  ...
  },
  {
    ...
    models: [
      ...
      { id: 'copilot-sub-claude-opus-4.7', label: 'Claude Opus 4.7', contextWindow: 200000, costTier: 'high', capabilities: ['chat', 'vision', 'function_calling'], multimodal: true, premiumMultiplier: 3, positioning: '💎 3x · Anthropic 4.7' },
      { id: 'copilot-sub-claude-opus-4.8', label: 'Claude Opus 4.8', contextWindow: 200000, costTier: 'high', capabilities: ['chat', 'vision', 'function_calling'], multimodal: true, premiumMultiplier: 3, positioning: '💎 3x · Anthropic 4.8 / 最新旗舰' },
    ],
  },
  {
  ...
  },
  {
    ...
    models: [
      // Opus 4.8 is the latest flagship — catalog ID forward-compat; maps to real Opus 4 at runtime until Anthropic GA.
      { id: 'claude-opus-4-8-20260601', label: 'Claude Opus 4.8 (最新旗舰)', contextWindow: 1000000, costTier: 'high', capabilities: ['chat', 'vision', 'function_calling'], multimodal: true, inputPrice: '$5.00', outputPrice: '$25.00', positioning: '🆕 4.8 / 最新Opus / 最强推理与代码', apiModelId: 'claude-opus-4-20250514' } as any,
      { id: 'claude-opus-4-7-20260401', label: 'Claude Opus 4.7', contextWindow: 1000000, costTier: 'high', capabilities: ['chat', 'vision', 'function_calling'], multimodal: true, inputPrice: '$5.00', outputPrice: '$25.00', positioning: '4.7 / 上一代旗舰', apiModelId: 'claude-opus-4-20250514' } as any,
  ...
  },
  {
    ...
    models: [
      // ── Anthropic Claude ──
      { id: 'us.anthropic.claude-opus-4-8-20260601-v1:0', label: 'Claude Opus 4.8 (最新旗舰)', contextWindow: 1000000, costTier: 'high', capabilities: ['chat', 'vision', 'function_calling'], multimodal: true, inputPrice: '$5.00', outputPrice: '$25.00', positioning: '🆕 4.8 / 最新Opus / 最强推理与代码' },
      { id: 'us.anthropic.claude-opus-4-7-20260401-v1:0', label: 'Claude Opus 4.7', contextWindow: 1000000, costTier: 'high', capabilities: ['chat', 'vision', 'function_calling'], multimodal: true, inputPrice: '$5.00', outputPrice: '$25.00', positioning: '4.7 / 上一代旗舰' },
  ...
  },
  {
    ...
    baseUrl: 'https://api.deepseek.com',
    models: [
      { id: 'deepseek-plan-v4.0-pro', label: 'DeepSeek V4.0 Pro (资源包)', contextWindow: 256000, costTier: 'free', capabilities: ['chat', 'vision', 'function_calling'], multimodal: true, positioning: '🆕 资源包/V4.0旗舰/极致性价比' },
      { id: 'deepseek-plan-v4.0-flash', label: 'DeepSeek V4.0 Flash (资源包)', contextWindow: 128000, costTier: 'free', capabilities: ['chat', 'vision', 'function_calling'], multimodal: true, positioning: '🆕 资源包/V4.0极速/高并发' },
  ...
  },
  {
    ...
    baseUrl: 'https://api.deepseek.com',
    models: [
      { id: 'deepseek-v4.0-pro', label: 'DeepSeek V4.0 Pro (最新旗舰)', contextWindow: 256000, costTier: 'medium', capabilities: ['chat', 'vision', 'function_calling'], multimodal: true, inputPrice: '¥2.0', outputPrice: '¥3.0', positioning: '🆕 V4.0 / 最强推理+代码/极致性价比' },
      { id: 'deepseek-v4.0-flash', label: 'DeepSeek V4.0 Flash (极速)', contextWindow: 128000, costTier: 'low', capabilities: ['chat', 'vision', 'function_calling'], multimodal: true, inputPrice: '¥0.5', outputPrice: '¥1.5', positioning: '🆕 V4.0 / 极速/高并发/低成本' },
      { id: 'deepseek-v3.2', label: 'DeepSeek V3.2 (上一代)', contextWindow: 128000, costTier: 'medium', capabilities: ['chat', 'vision', 'function_calling'], multimodal: true, inputPrice: '¥2.0', outputPrice: '¥3.0', positioning: '上一代/理科推理' },
    ],
  },
  {
  ...
  {
    // 小米 MiMo 开放平台 (platform.xiaomimimo.com) — OpenAI 兼容端点。
    // base URL 经检索官方平台确认为 https://api.xiaomimimo.com/v1 (另有
    // /anthropic 的 Anthropic Messages 兼容端点)。模型: V2.5 Pro (旗舰 MoE),
    // V2 Omni (图/视频/音频全模态), V2 Flash (极速/低成本, 262K 上下文)。
    id: 'xiaomi', name: '小米 (MiMo)', icon: '📱', region: 'china', currency: 'CNY', billingType: 'api-key',
    requiredFields: ['apiKey'], optionalFields: ['baseUrl'],
    placeholder: { apiKey: 'sk-...' },
    baseUrl: 'https://api.xiaomimimo.com/v1',
    models: [
      { id: 'mimo-v2.5-pro', label: 'MiMo V2.5 Pro (旗舰)', contextWindow: 1000000, costTier: 'medium', capabilities: ['chat', 'vision', 'function_calling'], multimodal: true, inputPrice: '$1.0', outputPrice: '$3.0', positioning: '🆕 小米旗舰/1T MoE/推理+代码+Agent/极致性价比' },
      { id: 'mimo-v2-omni', label: 'MiMo V2 Omni (全模态)', contextWindow: 256000, costTier: 'medium', capabilities: ['chat', 'vision', 'function_calling'], multimodal: true, inputPrice: '$1.0', outputPrice: '$3.0', positioning: '🆕 图/视频/音频全模态/视觉定位+工具调用' },
      { id: 'mimo-v2-flash', label: 'MiMo V2 Flash (极速)', contextWindow: 262144, costTier: 'low', capabilities: ['chat', 'function_calling'], multimodal: false, inputPrice: '$0.3', outputPrice: '$1.0', positioning: '🆕 极速/高并发/低成本/开源可自部署' },
    ],
  },
  {
    id: 'xiaomi-plan', name: '小米 MiMo 订阅', icon: '📱', region: 'china', currency: 'CNY', billingType: 'subscription',
    requiredFields: ['apiKey'], optionalFields: ['baseUrl'],
    credentialLabel: 'API Key (订阅)',
    placeholder: { apiKey: 'sk-...', baseUrl: 'https://api.xiaomimimo.com/v1' },
    baseUrl: 'https://api.xiaomimimo.com/v1',
    models: [
      { id: 'xiaomi-plan-mimo-v2.5-pro', label: 'MiMo V2.5 Pro 旗舰 (订阅)', contextWindow: 1000000, costTier: 'free', capabilities: ['chat', 'vision', 'function_calling'], multimodal: true, positioning: '🆕 订阅/小米旗舰/1T MoE' },
      { id: 'xiaomi-plan-mimo-v2-flash', label: 'MiMo V2 Flash (订阅)', contextWindow: 262144, costTier: 'free', capabilities: ['chat', 'function_calling'], multimodal: false, positioning: '订阅/极速/高并发' },
    ],
  },

  // ═══ 🎬 媒体创作 Provider（文生/图生 视频 · 图片 · 3D 模型）═══
  // 用户用自己的 key 创作视频/图片/3D。后端 video-generation / pet-generation
  // 已按 providerId 解析用户 BYO key(fal/huggingface/meshy),此处补上 UI 录入入口。
  {
    id: 'fal', name: 'fal.ai (视频/图片)', icon: '🎬', region: 'international', currency: 'USD', billingType: 'api-key',
    kind: 'media', mediaModalities: ['video', 'image'],
    requiredFields: ['apiKey'], optionalFields: [],
    credentialLabel: 'fal API Key',
    placeholder: { apiKey: 'fal-...' },
    models: [
      { id: 'fal-ai/kling-video/v2.1/master/image-to-video', label: 'Kling 2.1 图生视频', contextWindow: 0, costTier: 'medium', capabilities: ['image_to_video'], multimodal: true, positioning: '🆕 高质量图生视频' },
      { id: 'fal-ai/kling-video/v1/standard/text-to-video', label: 'Kling 文生视频', contextWindow: 0, costTier: 'medium', capabilities: ['text_to_video'], multimodal: true, positioning: '文生视频' },
      { id: 'fal-ai/flux/dev', label: 'FLUX 文生图', contextWindow: 0, costTier: 'low', capabilities: ['text_to_image'], multimodal: true, positioning: '文生图/高质量' },
    ],
  },
  {
    id: 'huggingface', name: 'Hugging Face (视频/图片)', icon: '🤗', region: 'international', currency: 'USD', billingType: 'api-key',
    kind: 'media', mediaModalities: ['video', 'image'],
    requiredFields: ['apiKey'], optionalFields: ['baseUrl'],
    credentialLabel: 'HF Token',
    placeholder: { apiKey: 'hf_...' },
    models: [
      { id: 'hf-text-to-video', label: 'HF 文生视频(开源)', contextWindow: 0, costTier: 'low', capabilities: ['text_to_video'], multimodal: true, positioning: '开源模型/可自选' },
      { id: 'hf-text-to-image', label: 'HF 文生图(开源)', contextWindow: 0, costTier: 'low', capabilities: ['text_to_image'], multimodal: true, positioning: '开源模型/SD系' },
    ],
  },
  {
    id: 'meshy', name: 'Meshy (3D 模型)', icon: '🧊', region: 'international', currency: 'USD', billingType: 'api-key',
    kind: 'media', mediaModalities: ['3d'],
    requiredFields: ['apiKey'], optionalFields: [],
    credentialLabel: 'Meshy API Key',
    placeholder: { apiKey: 'msy_...' },
    models: [
      { id: 'meshy-image-to-3d', label: 'Meshy 图生3D', contextWindow: 0, costTier: 'medium', capabilities: ['image_to_3d'], multimodal: true, positioning: '照片→3D/纹理细节好' },
      { id: 'meshy-text-to-3d', label: 'Meshy 文生3D', contextWindow: 0, costTier: 'medium', capabilities: ['text_to_3d'], multimodal: true, positioning: '文字→3D' },
    ],
  },
  {
    id: 'tencent-3d', name: '腾讯混元 (3D/视频)', icon: '🐧', region: 'china', currency: 'CNY', billingType: 'api-key',
    kind: 'media', mediaModalities: ['3d', 'video'],
    requiredFields: ['apiKey', 'secretKey'], optionalFields: ['region'],
    credentialLabel: 'Tencent SecretId',
    placeholder: { apiKey: 'AKID...', secretKey: '...', region: 'ap-guangzhou' },
    models: [
      { id: 'hunyuan-image-to-3d', label: '混元 图生3D', contextWindow: 0, costTier: 'low', capabilities: ['image_to_3d'], multimodal: true, positioning: '中文优化/官方API/性价比' },
      { id: 'hunyuan-text-to-video', label: '混元 文生视频', contextWindow: 0, costTier: 'medium', capabilities: ['text_to_video'], multimodal: true, positioning: '中文文生视频' },
    ],
  },
];
