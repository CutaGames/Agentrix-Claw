...
export const PROFILE_REGISTRY: Record<ProfileId, ProfileDefinition> = {
  'personal-primary': {
    ...
    allowedApdus: ['SIGN_TX', 'SET_LIMITS', 'SET_WHITELIST_ROOT', 'SIGN_PROPOSAL', 'ACTIVATE_USER', 'APPLY_LIFECYCLE_TRANSITION', 'RETIRE'],
  ...
  'recovery-guardian': {
    ...
    allowedApdus: ['SIGN_PROPOSAL', 'APPLY_LIFECYCLE_TRANSITION'],
  ...
  'operator-policy-admin': {
    ...
    allowedApdus: ['SET_LIMITS', 'SET_WHITELIST_ROOT', 'SIGN_PROPOSAL', 'APPLY_LIFECYCLE_TRANSITION', 'RETIRE'],
  ...
  'resident-executor': {
    ...
    allowedApdus: ['SIGN_TX', 'SIGN_PROPOSAL'],
