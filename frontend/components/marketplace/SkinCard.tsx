...
export function SkinCard({ skin, onAddToCart, onBid, onBuyWithAxp }: SkinCardProps) {
  ...
  // Track if next/image failed (404 from CDN, optimizer error, etc.) so we
  // can fall back to the clan gradient block instead of showing a blank tile.
