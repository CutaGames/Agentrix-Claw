...
const FAQ_ITEMS = [
  ...
  {
    q: { zh: '订阅可以随时取消吗？', en: 'Can I cancel my subscription any time?' },
    a: { zh: '可以。订阅按月或按年扣款，可随时在「Me → 订阅」取消。已扣款的当期不退款，下个周期自动停止扣款。', en: 'Yes. Subscriptions are monthly or yearly. Cancel any time in "Me → Subscription". Current period is non-refundable, but auto-renew stops next cycle.' },
  },
  {
    q: { zh: '有团队 / 学生 / 教育折扣吗？', en: 'Are there team / student / education discounts?' },
    a: { zh: '学生：通过我们的教育合作申请 (`edu@agentrix.top`)，免费 Pro 订阅。团队：> 5 人联系 `bd@agentrix.top` 谈定制。教育合作机构享受全员免费。', en: 'Student: free Pro via education partnership (`edu@agentrix.top`). Team: > 5 seats, contact `bd@agentrix.top` for custom. Education partners get full-team free access.' },
  },
  {
    q: { zh: '在哪里能买 AXP？AXP 怎么用？', en: 'Where to buy AXP? How to spend it?' },
    a: { zh: '4 路获得：日常签到 / 对话激活 / 推广分成 / 消费返现。8 类消耗：订阅折扣 / 配额加购 / 限定皮肤 / NFT 预售 / 抽奖 / 集市置顶 / A2A 优先 / 贺卡模板。1 AXP = $0.001，12 个月过期。', en: '4 earn paths: daily check-in / chat / referral / cashback. 8 spend buckets: sub discount / quota / limited skins / NFT presale / lottery / pinning / A2A priority / greeting templates. 1 AXP = $0.001, expires after 12 months.' },
  },
  {
    q: { zh: '不喜欢可以退款吗？', en: 'What if I don\'t like it?' },
    a: { zh: '订阅：当期不退（与 Apple / Google 政策一致）。Marketplace 一次性购买：仅当皮肤描述严重不符时可退。AXP 一旦使用不可退；账号注销时未使用 AXP 作废。', en: 'Subscription: current period non-refundable (consistent with Apple / Google policies). Marketplace one-off: refund only if skin description is materially wrong. AXP non-refundable once spent; unused AXP voided on account deletion.' },
  },
];
