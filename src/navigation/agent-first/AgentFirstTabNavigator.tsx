...
function EconomyNavigator() {
  ...
  return (
    <EconomyStack.Navigator id={undefined} initialRouteName="EconomyHome" screenOptions={stackOptions(c)}>
      ...
      <EconomyStack.Screen name="CreationHome" component={CreationHomeScreen} options={{ headerShown: false }} />
      <EconomyStack.Screen name="CreationFeed" component={CreationFeedScreen} options={{ headerShown: false }} />
      <EconomyStack.Screen name="CreationCreator" component={CreationCreatorScreen as any} options={{ title: t({ en: 'Create', zh: '创作' }), headerShown: false }} />
      <EconomyStack.Screen name="CreationExperience" component={CreationExperienceScreen as any} options={{ headerShown: false }} />
      <EconomyStack.Screen name="CreationDetail" component={CreationDetailScreen as any} options={{ headerShown: false }} />
      <EconomyStack.Screen name="MyWorld" component={MyWorldScreen} options={{ headerShown: false }} />
      <EconomyStack.Screen name="UnifiedWorldMap" component={UnifiedWorldMapScreen} options={{ headerShown: false }} />
      <EconomyStack.Screen name="WorldCreationMarketplace" component={WorldCreationMarketplaceScreen} options={{ headerShown: false }} />
