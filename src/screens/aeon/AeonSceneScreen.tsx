  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.actionBar} contentContainerStyle={styles.actionBarContent}>
        ...
        <TouchableOpacity style={styles.actionChip} onPress={() => navigation.navigate('AeonLiveStage')}>
          <Text style={styles.actionEmoji}>🎤</Text>
          <Text style={styles.actionLabel}>直播厅</Text>
          <Text style={styles.actionHint}>脱口秀/上台/打赏</Text>
        </TouchableOpacity>
