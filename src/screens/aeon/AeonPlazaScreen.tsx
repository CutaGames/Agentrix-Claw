...
export default function AeonPlazaScreen() {
  ...
  return (
    ...
    >
      ...
      {/* 跨场所入口:从广场进活动现场(脱口秀/演出排期) */}
      <TouchableOpacity style={styles.liveEntry} onPress={() => navigation.navigate('AeonEvents')}>
        <Text style={styles.liveEntryText}>🎟️ 活动现场 · 脱口秀 / 预约 / 上台打赏 →</Text>
      </TouchableOpacity>
