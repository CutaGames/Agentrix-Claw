...
export default function AeonPlazaScreen() {
  ...
  return (
    ...
    >
      ...
      {/* 跨场所入口:从广场进直播厅(脱口秀/现场活动) */}
      <TouchableOpacity style={styles.liveEntry} onPress={() => navigation.navigate('AeonLiveStage')}>
        <Text style={styles.liveEntryText}>🎤 进直播厅 · 脱口秀 / 上台发言 / 打赏 →</Text>
      </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  liveEntry: { marginHorizontal: 16, marginBottom: 8, backgroundColor: '#140e2e', borderRadius: 12, paddingVertical: 10, paddingHorizontal: 14, borderWidth: 1, borderColor: 'rgba(167,139,250,0.4)' },
  liveEntryText: { color: '#fff', fontSize: 13, fontWeight: '700' },
