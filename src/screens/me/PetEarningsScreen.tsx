    ...
    >
      ...
      {summaryQ.isLoading && !summary ? (
        ...
        <View style={styles.balanceCard}>
          ...
          <Text style={styles.balanceSub}>≈ {formatUsd(summary?.axp.usdValueCents ?? 0)}</Text>
      ...
      <Text style={styles.disclaimer}>
        {t({
          en: 'AXP is a platform reward (1 AXP = $0.001), not a currency. USDT income shown is from on-chain marketplace settlements.',
          zh: 'AXP 为平台积分（1 AXP = $0.001），非货币。USDT 收入来自链上集市成交结算。',
        })}
      </Text>
    </ScrollView>
  );
