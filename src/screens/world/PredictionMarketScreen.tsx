...
import {
  View, Text, ScrollView, TouchableOpacity, ActivityIndicator, Modal, TextInput, Alert, StyleSheet,
} from 'react-native';
...
// StyleSheet.create keeps the literal types (fontWeight / alignItems) that a
// plain object literal widens to string.
