...
import {
  ...
  type MobileAllowedDesktopCommandKind,
...
export function DesktopControlScreen() {
  ...
  return (
    ...
    >
      ...
      <View style={styles.section} testID="desktop-control-remote-mutation-retired">
        <Text style={styles.sectionTitle}>{t({ en: 'Remote execution', zh: '远程执行' })}</Text>
        <Text style={styles.emptyText}>
          {t({
            en: 'Shell, file write and browser commands were removed from Mobile. Run them on the paired Desktop.',
            zh: '执行命令、写文件与打开浏览器已从 Mobile 移除，请在已配对的桌面端执行。',
          })}
        </Text>
      </View>
