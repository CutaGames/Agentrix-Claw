...
| text-mode-after-voice-controls | passed | 49-text-mode-after-voice-controls | chat-text-input |
...
| text-mode-before-drawer | passed | 51-text-mode-before-drawer | chat-text-input |
| wait-chat-ready-before-drawer-memory | passed | 52-wait-chat-ready-before-drawer-memory | agent-chat-screen |
| wait-chat-ready-memory | passed | 53-wait-chat-ready-memory | agent-chat-screen |
| tap-drawer-open-memory | passed | 54-before-drawer-open-memory | agent-chat-drawer-button [40,187][159,306] |
