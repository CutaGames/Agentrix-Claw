...
| wait-user-message-local-only | passed | 20-wait-user-message-local-only | local_smoke_ping |
| chat-local-only | passed |  | submitted local_smoke_ping |
...
| wait-user-message-auto | passed | 25-wait-user-message-auto | auto_smoke_ping |
| chat-auto | passed |  | submitted auto_smoke_ping |
...
| tap-send-cloud-only | failed | 29-before-send-cloud-only | node not found |
| fatal | failed |  | Could not find UI node for send-cloud-only (chat-send-button). |
