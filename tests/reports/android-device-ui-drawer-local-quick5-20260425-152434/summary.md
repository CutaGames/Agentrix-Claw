...
| wait-chat-ready-before-drawer-wearables | passed | 102-wait-chat-ready-before-drawer-wearables | agent-chat-screen |
| wait-chat-ready-wearables | passed | 105-wait-chat-ready-wearables | agent-chat-screen |
| tap-drawer-open-wearables | passed | 106-before-drawer-open-wearables | agent-chat-drawer-button [40,187][159,306] |
| wait-drawer-wearables | passed | 107-wait-drawer-wearables | 管理 |
| tap-drawer-item-wearables | passed | 108-before-drawer-item-wearables | 可穿戴设备 [192,1879][831,1946] |
| crash-drawer-wearables | passed |  | no fatal patterns |
| return-chat-after-drawer-wearables | passed | 113-return-chat-after-drawer-wearables-0 | agent-chat-screen |
| wait-chat-ready-before-drawer-scan | passed | 114-wait-chat-ready-before-drawer-scan | agent-chat-screen |
| wait-chat-ready-scan | passed | 117-wait-chat-ready-scan | agent-chat-screen |
| tap-drawer-open-scan | passed | 118-before-drawer-open-scan | agent-chat-drawer-button [40,187][159,306] |
| wait-drawer-scan | passed | 119-wait-drawer-scan | 管理 |
| tap-drawer-item-scan | passed | 120-before-drawer-item-scan | 扫码连接 [192,2047][831,2114] |
| crash-drawer-scan | passed |  | no fatal patterns |
| return-chat-after-drawer-scan | passed | 125-return-chat-after-drawer-scan-0 | agent-chat-screen |
| wait-chat-ready-before-drawer-permissions | passed | 126-wait-chat-ready-before-drawer-permissions | agent-chat-screen |
| wait-chat-ready-permissions | passed | 129-wait-chat-ready-permissions | agent-chat-screen |
| tap-drawer-open-permissions | passed | 130-before-drawer-open-permissions | agent-chat-drawer-button [40,187][159,306] |
| wait-drawer-permissions | passed | 131-wait-drawer-permissions | 管理 |
| tap-drawer-item-permissions | passed | 132-before-drawer-item-permissions | 权限管理 [192,2349][831,2416] |
| crash-drawer-permissions | passed |  | no fatal patterns |
| return-chat-after-drawer-permissions | passed | 137-return-chat-after-drawer-permissions-0 | agent-chat-screen |
| wait-chat-ready-before-drawer-agent-account | passed | 138-wait-chat-ready-before-drawer-agent-account | agent-chat-screen |
| wait-chat-ready-agent-account | passed | 141-wait-chat-ready-agent-account | agent-chat-screen |
| tap-drawer-open-agent-account | passed | 142-before-drawer-open-agent-account | agent-chat-drawer-button [40,187][159,306] |
| wait-drawer-agent-account | passed | 143-wait-drawer-agent-account | 管理 |
| tap-drawer-item-agent-account | passed | 144-before-drawer-item-agent-account | Agent 账号 [53,2467][907,2486] |
| crash-drawer-agent-account | passed |  | no fatal patterns |
| return-chat-after-drawer-agent-account | passed | 149-return-chat-after-drawer-agent-account-0 | agent-chat-screen |
| wait-chat-ready-before-drawer-team-space | passed | 150-wait-chat-ready-before-drawer-team-space | agent-chat-screen |
| wait-chat-ready-team-space | passed | 153-wait-chat-ready-team-space | agent-chat-screen |
| tap-drawer-open-team-space | passed | 154-before-drawer-open-team-space | agent-chat-drawer-button [40,187][159,306] |
| wait-drawer-team-space | passed | 155-wait-drawer-team-space | 管理 |
| tap-drawer-item-team-space | warning | 156-before-drawer-item-team-space | node not present |
| tap-drawer-item-team-space | passed | 157-before-drawer-item-team-space | 团队空间 [192,2222][831,2289] |
| crash-drawer-team-space | passed |  | no fatal patterns |
| return-chat-after-drawer-team-space | passed | 162-return-chat-after-drawer-team-space-0 | agent-chat-screen |
| wait-chat-ready-before-drawer-console | passed | 163-wait-chat-ready-before-drawer-console | agent-chat-screen |
| wait-chat-ready-console | passed | 166-wait-chat-ready-console | agent-chat-screen |
| tap-drawer-open-console | passed | 167-before-drawer-open-console | agent-chat-drawer-button [40,187][159,306] |
| wait-drawer-console | passed | 168-wait-drawer-console | 管理 |
| tap-drawer-item-console | warning | 169-before-drawer-item-console | node not present |
| tap-drawer-item-console | passed | 170-before-drawer-item-console | Agent 完整控制台 [192,2417][831,2484] |
| crash-drawer-console | passed |  | no fatal patterns |
| return-chat-after-drawer-console | passed | 175-return-chat-after-drawer-console-0 | agent-chat-screen |
| tap-me tab for local model | passed | 176-before-me-tab-for-local-model | 我的 [900,2445][1200,2486] |
| tap-scroll-settings menu | passed | 178-scroll-settings-menu-1 | 设置 [234,1957][1035,2024] |
| wait-settings screen | passed | 179-wait-settings-screen | 设置 |
| tap-scroll-local ai model | passed | 182-scroll-local-ai-model-2 | 本地 AI 模型 [56,340][1144,349] |
| wait-local ai model screen | passed | 183-wait-local-ai-model-screen | local-ai-model-screen |
