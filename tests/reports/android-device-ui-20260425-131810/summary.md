...
| tap-duplex toggle | passed | 37-before-duplex-toggle | chat-duplex-toggle [946,590][1134,689] |
| tap-voice mode toggle | failed | 39-before-voice-mode-toggle | node not found |
| fatal | failed |  | Could not find UI node for voice mode toggle (chat-voice-mode-toggle). |
