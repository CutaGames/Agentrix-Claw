...
| tap-drawer-item-wearables | passed | 88-before-drawer-item-wearables | 可穿戴设备 [192,1879][831,1946] |
| crash-drawer-wearables | passed |  | no fatal patterns |
| tap-drawer-open-scan | passed | 93-before-drawer-open-scan | agent-chat-drawer-button [40,187][159,306] |
| wait-drawer-scan | passed | 94-wait-drawer-scan | 管理 |
| tap-drawer-item-scan | passed | 95-before-drawer-item-scan | 扫码连接 [192,2047][831,2114] |
| crash-drawer-scan | passed |  | no fatal patterns |
| tap-drawer-open-permissions | warning | 100-before-drawer-open-permissions | node not present |
| tap-drawer-open-permissions-fallback | passed |  | coordinate 100,245 |
| wait-drawer-permissions | failed |  | timeout 10s |
| tap-drawer-item-permissions | failed | 104-before-drawer-item-permissions | node not found |
| fatal | failed |  | Could not find UI node for drawer-item-permissions (权限管理, Permissions). |
